...
IUSE="bitwriter debug doc exegesis gold libedit +libffi lld mcjit ncurses
	passes test xar xml z3
...
PATCHES=("${FILESDIR}"/${P}-cmake-llvm-config-interface-libs.patch)
